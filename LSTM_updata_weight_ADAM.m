...
[updates_delta_weight_preh_h_temp,   state] = Adam2(delta_weight_preh_h_temp, b, stepsize, p, state);
...
for num=1:output_num
    ...
    [updates_delta_weight_outputgate_x,   state_9] = Adam2(delta_weight_outputgate_x, b, stepsize, p, state_9);
    [updates_delta_weight_outputgate_x_other,   state_9_other] =Adam2(delta_weight_outputgate_x_other, b, stepsize, p, state_9_other);
...
%tau_gradient_inputgate_x= 2*(weight_preh_h(:,num)*Error(num,1))'.*output_gate.*(ones(size(cell_state(:,n)))-tanh(cell_state(:,n)).^2)'.*gate.*exp(-input_gate_input).*(input_gate.^2)*train_data(m,n);
 ...
 [updates_delta_weight_inputgate_x,   state_1] = Adam2(delta_weight_inputgate_x, b, stepsize,  p,  state_1);
weight_inputgate_x=weight_inputgate_x-updates_delta_weight_inputgate_x;
[updates_delta_weight_inputgate_x_other,   state_1_other] = Adam2(delta_weight_inputgate_x_other, b, stepsize,  p, state_1_other);
    %weight_inputgate_x=weight_inputgate_x-updates_delta_weight_inputgate_x;
...
if(n~=1)
    ...
    [updates_delta_weight_input_x,   state_2] = Adam2(delta_weight_input_x, b, stepsize,  p, state_2);
    weight_input_x=weight_input_x-updates_delta_weight_input_x;
    
    % tau =tau - 0.001*tau_gradient_input_x;
    [updates_delta_weight_input_x_other,   state_2_other] = Adam2(delta_weight_input_x_other, b, stepsize,  p, state_2_other);
    %weight_input_x=weight_input_x-updates_delta_weight_input_x;
    ...
    [updates_delta_weight_forgetgate_x,   state_3] = Adam2( delta_weight_forgetgate_x, b, stepsize,  p, state_3);
    weight_forgetgate_x=weight_forgetgate_x-updates_delta_weight_forgetgate_x;
    
    %tau =tau - 0.001*tau_gradient_forgetgate_x;
    [updates_delta_weight_forgetgate_x_other,   state_3_other] = Adam2(delta_weight_forgetgate_x_other, b, stepsize,  p, state_3_other);
   % weight_forgetgate_x=weight_forgetgate_x-updates_delta_weight_forgetgate_x;
    ...
    [updates_delta_weight_inputgate_c,   state_4] = Adam2( delta_weight_inputgate_c, b, stepsize,  p, state_4);
    weight_inputgate_c=weight_inputgate_c-updates_delta_weight_inputgate_c;
    %tau =tau - 0.1*tau_gradient_inputgate_c;
    [updates_delta_weight_inputgate_c_other,   state_4_other] = Adam2(delta_weight_inputgate_c_other, b, stepsize, p, state_4_other);
    %weight_inputgate_c=weight_inputgate_c-updates_delta_weight_inputgate_c;
    ...
    [updates_delta_weight_forgetgate_c,   state_5] = Adam2( delta_weight_forgetgate_c, b, stepsize,  p, state_5);
    weight_forgetgate_c=weight_forgetgate_c-updates_delta_weight_forgetgate_c;
    
    %tau =tau - 0.1*tau_gradient_forgetgate_c;
    [updates_delta_weight_forgetgate_c_other,   state_5_other] = Adam2(delta_weight_forgetgate_c_other, b, stepsize,  p, state_5_other);
    %weight_forgetgate_c=weight_forgetgate_c-updates_delta_weight_forgetgate_c;
    ...
    [updates_delta_weight_ouputgate_c,   state_6] = Adam2(delta_weight_outputgate_c, b, stepsize, p, state_6);
    weight_outputgate_c=weight_outputgate_c - updates_delta_weight_ouputgate_c;
    
    %tau =tau - 0.001*tau_gradient_outputgate_c;
    [updates_delta_weight_outputgate_c_other,   state_6_other] = Adam2(delta_weight_outputgate_c_other, b, stepsize,  p, state_6_other);
    ...
    for m=1:output_num
     ...
     [updates_delta_weight_input_h,   state_7] = Adam2( delta_weight_input_h, b, stepsize, p, state_7);
    weight_input_h=weight_input_h-updates_delta_weight_input_h;
   
    %tau =tau - 0.1*tau_gradient_input_h;
    [updates_delta_weight_input_h_other,   state_7_other] = Adam2(delta_weight_input_h_other, b, stepsize,  p, state_7_other);
    %weight_input_h=weight_input_h-updates_delta_weight_input_h;
    ...
    [updates_delta_weight_input_x,   state_8] = Adam2( delta_weight_input_x, b, stepsize,  p, state_8);
    weight_input_x=weight_input_x-updates_delta_weight_input_x;
    
    %tau =tau - 0.1*tau_gradient_input_x;
    [updates_delta_weight_input_x_other,   state_8_other] = Adam2(delta_weight_input_x_other, b, stepsize,  p, state_8_other);
    %weight_input_h=weight_input_h-updates_delta_weight_input_h;
     weight_input_x = So(tau,weight_input_x);
     weight_input_x_other=weight_input_x_other - updates_delta_weight_input_x_other;
     weight_input_x_other = So(tau,weight_input_x_other);
