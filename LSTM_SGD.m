function [stats_SGD, Error_iter]=LSTM_SGD(data_length, data_num,train_data, test_data, input_num, cell_num,output_num,bias_input_gate,bias_forget_gate,.....
...
for iter=1:20
    ...
    for m=1:data_num
        ...
        Error=r(:,m)-test_data(:,m);
        stats_SGD(:, iter)= confusionmatStats(test_data(:,m), h_state(:,m));
        ...
        if(Error_Cost(1,iter)<cost_gate)
            ...
            [   weight_input_x,...
                ...
                weight_outputgate_x,...
                weight_outputgate_c,...
                weight_preh_h ]=LSTM_updata_weight_SGD(m,yita,Error,...
                                                   weight_input_x,...
                                                   weight_input_h,...
                                                   weight_inputgate_x,...
                                                   weight_inputgate_c,...
