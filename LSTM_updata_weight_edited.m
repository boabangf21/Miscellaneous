...
for num=1:output_num
    ...
    [updates_delta_weight_outputgate_x,   state_1] = AMSgrad(delta_weight_outputgate_x, b, stepsize, p, state_1);
...
for m=1:data_length
 ...
 [updates_delta_weight_inputgate_x,   state_2] = AMSgrad(delta_weight_inputgate_x, b, stepsize, p, state_2);
...
if(n~=1)
    ...
    [updates_delta_weight_input_x,   state_3] = AMSgrad(delta_weight_input_x, b, stepsize, p, state_3);
    ...
    [updates_delta_weight_forgetgate_x,   state_4] = AMSgrad( delta_weight_forgetgate_x, b, stepsize, p, state_4);
    ...
    [updates_delta_weight_inputgate_c,   state_5] = AMSgrad( delta_weight_inputgate_c, b, stepsize, p, state_5);
    ...
    for m=1:cell_num
     ...
     [updates_delta_weight_forgetgate_c,   state_6] = AMSgrad( delta_weight_forgetgate_c, b, stepsize, p, state_6);
    ...
    [updates_delta_weight_forgetgate_c,   state_6] = AMSgrad(delta_weight_outputgate_c, b, stepsize, p, state_6);
