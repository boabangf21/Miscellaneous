function [   weight_input_x,weight_input_h,weight_inputgate_x,weight_inputgate_c,weight_forgetgate_x,weight_forgetgate_c,weight_outputgate_x,weight_outputgate_c,weight_preh_h ]=LSTM_updata_weight_padam(n,yita,Error,...
...
[updates_delta_weight_preh_h_temp,   state] = Copy_2_of_AMSgrad(delta_weight_preh_h_temp, b, stepsize, p, state);
...
for num=1:output_num
    ...
    [updates_delta_weight_outputgate_x,   state_1] = Copy_2_of_AMSgrad(delta_weight_outputgate_x, b, stepsize, p, state_1);
...
for m=1:data_length
 ...
 [updates_delta_weight_inputgate_x,   state_2] = Copy_2_of_AMSgrad(delta_weight_inputgate_x, b, stepsize, p, state_2);
...
if(n~=1)
    ...
    [updates_delta_weight_input_x,   state_3] = Copy_2_of_AMSgrad(delta_weight_input_x, b, stepsize, p, state_3);
    ...
    [updates_delta_weight_forgetgate_x,   state_4] = Copy_2_of_AMSgrad( delta_weight_forgetgate_x, b, stepsize, p, state_4);
    ...
    [updates_delta_weight_inputgate_c,   state_5] = Copy_2_of_AMSgrad( delta_weight_inputgate_c, b, stepsize, p, state_5);
    ...
    for m=1:cell_num
     ...
     [updates_delta_weight_forgetgate_c,   state_6] = Copy_2_of_AMSgrad( delta_weight_forgetgate_c, b, stepsize, p, state_6);
    ...
    [updates_delta_weight_forgetgate_c,   state_7] = Copy_2_of_AMSgrad(delta_weight_outputgate_c, b, stepsize, p, state_7);
    ...
    for m=1:output_num
     ...
     [updates_delta_weight_input_h,   state_8] = Copy_2_of_AMSgrad( delta_weight_input_h, b, stepsize, p, state_8);
    ...
    [updates_delta_weight_input_x,   state_9] = Copy_2_of_AMSgrad( delta_weight_input_x, b, stepsize, p, state_9);
    weight_input_x=weight_input_x-updates_delta_weight_input_x;
    end
end
