function [Accuracy,Precision, Error_iter_AMSgrad]=LSTM_ADAM(data_length,data_num, train_data, test_data, test_hstate,test_final,  input_num, cell_num,output_num,bias_input_gate,bias_forget_gate,.....
    ...
    stats_proposed= confusionmatStats(test_data(:,m), h_state(:,m));
        ...
        if(Error_Cost(1,iter)<cost_gate)
            ...
            [   weight_input_x,weight_input_x_other,...
                ...
                weight_preh_h, weight_preh_h_other, tau]=LSTM_updata_weight_ADAM(m,yita,Error,...
                                                   weight_input_x,weight_input_x_other,...
                                                   weight_input_h,weight_input_h_other,...
                                                   weight_inputgate_x, weight_inputgate_x_other,...
                                                   weight_inputgate_c,weight_inputgate_c_other,...
